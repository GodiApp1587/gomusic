...
class MyTheme with ChangeNotifier {
  ...
  String accentColor =
      Hive.box('settings').get('themeColor', defaultValue: 'Light Green') as String;
  String canvasColor =
  ...
  void refresh() {
    ...
    accentColor = settingsBox.get('themeColor', defaultValue: 'Light Green') as String;
    canvasColor =
  ...
  Color currentColor() {
    switch (accentColor) {
      ...
      default:
        return _isDark ? Colors.lightGreenAccent[500]! : Colors.lightBlue[400]!;
    }
  }
